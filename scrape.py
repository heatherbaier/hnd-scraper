...
driver = webdriver.Chrome(executable_path = "/Users/heatherbaier/Documents/hn_scrape/chromedriver")
...
for pagina in range(1, 3):
    ...
    try:
        ...
        for inp in inputs:
            ...
            pdfkit.from_url(f"http://estadisticas.se.gob.hn/see/boleta_basica_p8_mostrar.php?id={boleta_input.get_attribute('value')}", f'pdfs/school_{inp}.pdf')
